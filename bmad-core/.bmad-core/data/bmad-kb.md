...
- **Documentation**: Professional PRDs, architecture docs, features, user stories
...
- **featureFilePattern**: Pattern for feature filenames (e.g., `feature-{n}.{n}*.md`)
...
3. **Development Cycle** (Sequential, one story at a time):
   ...
   **Step 3 - Repeat**: Continue SM → Dev cycle until all epics, features and stories complete

**Important**: Only 1 story in progress at a time, worked sequentially until all epics, features and stories complete.
