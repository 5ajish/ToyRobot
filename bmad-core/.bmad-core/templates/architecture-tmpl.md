...
[[LLM: Mermaid diagrams should always be wrapped with `::: mermaid`]]
...
2. Include all endpoints from epics/features/stories
...
│   └── {{iac-files}}          # IaC definitions
├── scripts/                    # Utility scripts
│   └── {{script-files}}       # Build/setup scripts
...
├── {{dependency-file}}        # Dependency manifest (package.json, requirements.txt, etc.)
...
- First epic/feature/story to implement
