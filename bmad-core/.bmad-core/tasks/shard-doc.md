...
**Note for PRDs with Features**: When sharding a PRD that uses the Epic->Feature->Story pattern, each Epic file will contain its features (### Feature N.N) and stories (#### Story N.N.N) as subsections.
